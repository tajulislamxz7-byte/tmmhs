          ...
          <div class="footer-grid">
            ...
            <div>
              ...
              <ul class="footer-links">
                ...
                <li><a onclick="navigate('attendance')" style="cursor:pointer;display:flex;align-items:center;gap:8px;">${S('<path d="M22 11.08V12a10 10 0 1 1-5.93-9.14"/><polyline points="22 4 12 14.01 9 11.01"/>',14,'rgba(255,255,255,0.5)')} Attendance</a></li>
